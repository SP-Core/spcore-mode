...
public class PositionalAudioUtils {
    ...
    private static float[] getStereoVolume(Vec3d soundPos) {
        ...
        return getStereoVolume(mainCamera.getPos(), mainCamera.getRotation().y, soundPos);
    }
    ...
    public static float getDistanceVolume(float maxDistance, Vec3d pos) {
        return getDistanceVolume(maxDistance, mc.gameRenderer.getCamera().getPos(), pos);
    }
    ...
    public static short[] convertToStereoForRecording(float maxDistance, Vec3d pos, short[] monoData) {
        return convertToStereoForRecording(maxDistance, mc.gameRenderer.getCamera().getPos(), mc.gameRenderer.getCamera().getRotation().y, pos, monoData);
    }

    public static short[] convertToStereoForRecording(float maxDistance, Vec3d pos, short[] monoData, float volume) {
        return convertToStereoForRecording(maxDistance, mc.gameRenderer.getCamera().getPos(), mc.gameRenderer.getCamera().getRotation().y, pos, monoData, volume);
    }
